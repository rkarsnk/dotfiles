...
- ホスト固有の darwin 設定: [hosts/MacBookNeo](hosts/MacBookNeo), [hosts/MacMiniM4](hosts/MacMiniM4)
...
- マシン依存の設定は [hosts/MacBookNeo](hosts/MacBookNeo) / [hosts/MacMiniM4](hosts/MacMiniM4) のような `hosts/<machine>` に置く
